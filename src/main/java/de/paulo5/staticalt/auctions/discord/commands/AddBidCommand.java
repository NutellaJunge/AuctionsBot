...
public class AddBidCommand extends ListenerAdapter {

    private final String id;

    public AddBidCommand(JDA jda) {
        id = jda.upsertCommand("addbid", "Bid on a Auction")
    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent event) {
        ...
        try {
            ...
            if (!auction.isClosed()) {
                try {
                    int user = Tables.userTable.getUser(event.getOption("user").getAsMember());
